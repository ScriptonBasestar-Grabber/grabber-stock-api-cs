namespace XingBot.res
{
    ...
    public class _KM__OutBlock
    {
        ...
        public decimal k50jisu{ get; set; } // [float ,  6.2] KOSDAQ50 지수                   StartPos 351, Length 6
        public string k50sign{ get; set; } // [string,    1] KOSDAQ50 전일대비구분           StartPos 358, Length 1
        public decimal change{ get; set; } // [float ,  6.2] KOSDAQ50 전일대비               StartPos 360, Length 6
        public decimal k50basis{ get; set; } // [float ,  4.2] KOSDAQ50 베이시스               StartPos 367, Length 4
        ...
        public long p_bvalcha{ get; set; } // [long  ,    8] 비차익매수체결금액직전대비      StartPos 615, Length 8
