namespace XingBot.res
{
    ...
    struct _IJ__OutBlock
    {
        public string time; // [string,    6] 시간                            StartPos 0, Length 6
        public float jisu; // [float ,  8.2] 지수                            StartPos 7, Length 8
        public string sign; // [string,    1] 전일대비구분                    StartPos 16, Length 1
        public float change; // [float ,  8.2] 전일비                          StartPos 18, Length 8
        public float drate; // [float ,  6.2] 등락율                          StartPos 27, Length 6
        ...
        public float upjrate; // [float ,  6.2] 상승종목비율                    StartPos 86, Length 6
        public float openjisu; // [float ,  8.2] 시가지수                        StartPos 93, Length 8
        public string opentime; // [string,    6] 시가시간                        StartPos 102, Length 6
        public float highjisu; // [float ,  8.2] 고가지수                        StartPos 109, Length 8
        public string hightime; // [string,    6] 고가시간                        StartPos 118, Length 6
        public float lowjisu; // [float ,  8.2] 저가지수                        StartPos 125, Length 8
