namespace XingBot.res
{
    ...
    public class _OC0_OutBlock
    {
        ...
        public decimal eqva{ get; set; } // [float ,  7.2] KOSPI등가                       StartPos 170, Length 7
        public decimal theoryprice{ get; set; } // [float ,  6.2] 이론가                          StartPos 178, Length 6
        public decimal impv{ get; set; } // [float ,  6.2] 내재변동성                      StartPos 185, Length 6
        public long openyakcha{ get; set; } // [long  ,    8] 미결제약정증감                  StartPos 192, Length 8
        public decimal timevalue{ get; set; } // [float ,  6.2] 시간가치                        StartPos 201, Length 6
        public string jgubun{ get; set; } // [string,    2] 장운영정보                      StartPos 208, Length 2
        public long jnilvolume{ get; set; } // [long  ,   12] 전일동시간대거래량              StartPos 211, Length 12
        public string optcode{ get; set; } // [string,    8] 단축코드                        StartPos 224, Length 8
    }
}