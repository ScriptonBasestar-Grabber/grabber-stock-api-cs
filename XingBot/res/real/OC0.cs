namespace XingBot.res
{
    ...
    struct _OC0_OutBlock
    {
        ...
        public float eqva; // [float ,  7.2] KOSPI등가                       StartPos 170, Length 7
        public float theoryprice; // [float ,  6.2] 이론가                          StartPos 178, Length 6
        public float impv; // [float ,  6.2] 내재변동성                      StartPos 185, Length 6
        public long openyakcha; // [long  ,    8] 미결제약정증감                  StartPos 192, Length 8
        public float timevalue; // [float ,  6.2] 시간가치                        StartPos 201, Length 6
