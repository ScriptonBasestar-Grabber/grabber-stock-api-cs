namespace XingBot.res
{
    ...
    struct _NC0_OutBlock
    {
        ...
        public float drate; // [float ,  6.2] 등락율                          StartPos 23, Length 6
        ...
        public float theoryprice; // [float ,  6.2] 이론가                          StartPos 177, Length 6
        public float kasis; // [float ,  6.2] 괴리율                          StartPos 184, Length 6
        public float sbasis; // [float ,  6.2] 시장BASIS                       StartPos 191, Length 6
        public float ibasis; // [float ,  6.2] 이론BASIS                       StartPos 198, Length 6
