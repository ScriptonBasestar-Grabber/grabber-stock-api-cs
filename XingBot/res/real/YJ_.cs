namespace XingBot.res
{
    ...
    public struct _YJ__OutBlock
    {
        ...
        public decimal jisu; // [float ,  8.2] 예상지수                        StartPos 7, Length 8
        public string sign; // [string,    1] 예상전일대비구분                StartPos 16, Length 1
        public decimal change; // [float ,  8.2] 예상전일비                      StartPos 18, Length 8
        public decimal drate; // [float ,  6.2] 예상등락율                      StartPos 27, Length 6
