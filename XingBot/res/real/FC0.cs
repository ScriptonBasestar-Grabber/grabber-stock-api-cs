namespace XingBot.res
{
    ...
    public struct _FC0_OutBlock
    {
        ...
        public decimal theoryprice; // [float ,  6.2] 이론가                          StartPos 170, Length 6
        public decimal kasis; // [float ,  6.2] 괴리율                          StartPos 177, Length 6
        public decimal sbasis; // [float ,  6.2] 시장BASIS                       StartPos 184, Length 6
        public decimal ibasis; // [float ,  6.2] 이론BASIS                       StartPos 191, Length 6
