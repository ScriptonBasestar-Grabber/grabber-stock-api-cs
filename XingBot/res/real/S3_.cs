namespace XingBot.res
{
    ...
    public class _S3__InBlock
    {
        public char shcode{ get; set; } // [string,    6] 단축코드                        StartPos 0, Length 6
    }

    public class _S3__OutBlock
    {
        ...
        public string shcode{ get; set; } // [string,    6] 단축코드                        StartPos 216, Length 6
    }
}