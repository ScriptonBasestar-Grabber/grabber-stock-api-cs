namespace XingBot.res
{
    ...
    struct _JC0_OutBlock
    {
        ...
        public double drate; // [double,  6.2] 등락율                          StartPos 29, Length 6
        ...
        public double cpower; // [double,  9.2] 체결강도                        StartPos 162, Length 9
        ...
        public double k200jisu; // [double,  6.2] KOSPI200지수                    StartPos 203, Length 6
        public long theoryprice; // [long  ,    8] 이론가                          StartPos 210, Length 8
        public double kasis; // [double,  6.3] 괴리율                          StartPos 219, Length 6
