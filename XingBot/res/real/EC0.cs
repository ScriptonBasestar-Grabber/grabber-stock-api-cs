namespace XingBot.res
{
    ...
    struct _EC0_OutBlock
    {
        ...
        public float change; // [float ,  6.2] 정규장종가대비                  StartPos 16, Length 6
        public float drate; // [float ,  6.2] 정규장종가기준등락율            StartPos 23, Length 6
        public float price; // [float ,  6.2] 현재가                          StartPos 30, Length 6
        public float open; // [float ,  6.2] 시가                            StartPos 37, Length 6
        public float high; // [float ,  6.2] 고가                            StartPos 44, Length 6
        public float low; // [float ,  6.2] 저가                            StartPos 51, Length 6
        ...
        public float cpower; // [float ,  9.2] 체결강도                        StartPos 137, Length 9
        public float offerho1; // [float ,  6.2] 매도호가1                       StartPos 147, Length 6
        public float bidho1; // [float ,  6.2] 매수호가1                       StartPos 154, Length 6
        public long openyak; // [long  ,    8] 미결제약정수량                  StartPos 161, Length 8
        public float k200jisu; // [float ,  6.2] KOSPI200지수                    StartPos 170, Length 6
        public float eqva; // [float ,  7.2] KOSPI등가                       StartPos 177, Length 7
        public float theoryprice; // [float ,  6.2] 이론가                          StartPos 185, Length 6
        public float impv; // [float ,  6.2] 내재변동성                      StartPos 192, Length 6
        public long openyakcha; // [long  ,    8] 미결제약정증감                  StartPos 199, Length 8
        public float timevalue; // [float ,  6.2] 시간가치                        StartPos 208, Length 6
