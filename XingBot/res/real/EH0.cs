namespace XingBot.res
{
    ...
    struct _EH0_OutBlock
    {
        ...
        public double offerho2; // [double,  6.2] 매도호가2                       StartPos 56, Length 6
        public double bidho2; // [double,  6.2] 매수호가2                       StartPos 63, Length 6
        ...
        public double offerho3; // [double,  6.2] 매도호가3                       StartPos 98, Length 6
        public double bidho3; // [double,  6.2] 매수호가3                       StartPos 105, Length 6
        ...
        public double offerho4; // [double,  6.2] 매도호가4(미제공)               StartPos 140, Length 6
        public double bidho4; // [double,  6.2] 매수호가4(미제공)               StartPos 147, Length 6
        ...
        public double offerho5; // [double,  6.2] 매도호가5(미제공)               StartPos 182, Length 6
        public double bidho5; // [double,  6.2] 매수호가5(미제공)               StartPos 189, Length 6
