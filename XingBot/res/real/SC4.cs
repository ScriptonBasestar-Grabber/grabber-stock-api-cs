namespace XingBot.res
{
    ...
    public class _SC4_InBlock
    {
    }

    public class _SC4_OutBlock
    {
        ...
        public char strtgcode{ get; set; } // [string,    6] 전략코드                        StartPos 925, Length 6
        public char grpId{ get; set; } // [string,   20] 그룹Id                          StartPos 931, Length 20
        ...
        public char orduserId{ get; set; } // [string,   16] 주문자Id                        StartPos 1001, Length 16
        public long brwmgmtYn{ get; set; } // [long  ,    1] 차입관리여부                    StartPos 1017, Length 1
        public char frgrunqno{ get; set; } // [string,    6] 외국인고유번호                  StartPos 1018, Length 6
        public char trtzxLevytp{ get; set; } // [string,    1] 거래세징수구분                  StartPos 1024, Length 1
        public char lptp{ get; set; } // [string,    1] 유동성공급자구분                StartPos 1025, Length 1
        public char exectime{ get; set; } // [string,    9] 체결시각                        StartPos 1026, Length 9
        public char rcptexectime{ get; set; } // [string,    9] 거래소수신체결시각              StartPos 1035, Length 9
