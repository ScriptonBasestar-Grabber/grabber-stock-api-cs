...
{
    // 선물접수 ( KEY=8, GROUP=1 )
    public class _O01_InBlock
    {
    }

    public class _O01_OutBlock
    {
        ...
        public string userId{ get; set; } // [userId,   16] 주문자Id                        StartPos 574, Length 16
        public string opdrtnno{ get; set; } // [opdrtnno,   12] 운영지시번호                    StartPos 590, Length 12
        public string rjtcode{ get; set; } // [rjtcode,    3] 부적격코드                      StartPos 602, Length 3
        public long mrccnfqty{ get; set; } // [mrccnfqty  ,   16] 정정취소확인수량                StartPos 605, Length 16
        public long orgordunercqty{ get; set; } // [orgordunercqty  ,   16] 원주문미체결수량                StartPos 621, Length 16
        public long orgordmrcqty{ get; set; } // [orgordmrcqty  ,   16] 원주문정정취소수량              StartPos 637, Length 16
        public string ctrcttime{ get; set; } // [ctrcttime,    8] 약정시각(체결시각)              StartPos 653, Length 8
        public string ctrctno{ get; set; } // [ctrctno,   10] 약정번호                        StartPos 661, Length 10
        public decimal execprc{ get; set; } // [execprc, 13.2] 체결가격                        StartPos 671, Length 13
        public long execqty{ get; set; } // [execqty  ,   16] 체결수량                        StartPos 684, Length 16
        public long newqty{ get; set; } // [newqty  ,   16] 신규체결수량                    StartPos 700, Length 16
        public long qdtqty{ get; set; } // [qdtqty  ,   16] 청산체결수량                    StartPos 716, Length 16
        public long lastqty{ get; set; } // [lastqty  ,   16] 최종결제수량                    StartPos 732, Length 16
        public long lallexecqty{ get; set; } // [lallexecqty  ,   16] 전체체결수량                    StartPos 748, Length 16
        public long allexecamt{ get; set; } // [allexecamt  ,   16] 전체체결금액                    StartPos 764, Length 16
        public string fnobalevaltp{ get; set; } // [fnobalevaltp,    1] 잔고평가구분                    StartPos 780, Length 1
        public long bnsplamt{ get; set; } // [bnsplamt  ,   16] 매매손익금액                    StartPos 781, Length 16
        public string fnoIsuno1{ get; set; } // [fnoIsuno1,    8] 선물옵션종목번호1               StartPos 797, Length 8
        public string bnstp1{ get; set; } // [bnstp1,    1] 매매구분1                       StartPos 805, Length 1
        public decimal execprc1{ get; set; } // [execprc1, 13.2] 체결가1                         StartPos 806, Length 13
        public long newqty1{ get; set; } // [newqty1  ,   16] 신규체결수량1                   StartPos 819, Length 16
        public long qdtqty1{ get; set; } // [qdtqty1  ,   16] 청산체결수량1                   StartPos 835, Length 16
        public long allexecamt1{ get; set; } // [allexecamt1  ,   16] 전체체결금액1                   StartPos 851, Length 16
        public string fnoIsuno2{ get; set; } // [fnoIsuno2,    8] 선물옵션종목번호2               StartPos 867, Length 8
        public string bnstp2{ get; set; } // [bnstp2,    1] 매매구분2                       StartPos 875, Length 1
        public decimal execprc2{ get; set; } // [execprc2, 13.2] 체결가2                         StartPos 876, Length 13
        public long newqty2{ get; set; } // [newqty2  ,   16] 신규체결수량2                   StartPos 889, Length 16
        public long lqdtqty2{ get; set; } // [lqdtqty2  ,   16] 청산체결수량2                   StartPos 905, Length 16
        public long allexecamt2{ get; set; } // [allexecamt2  ,   16] 전체체결금액2                   StartPos 921, Length 16
        public long dps{ get; set; } // [dps  ,   16] 예수금                          StartPos 937, Length 16
        public long ftsubtdsgnamt{ get; set; } // [ftsubtdsgnamt  ,   16] 선물대용지정금액                StartPos 953, Length 16
        public long mgn{ get; set; } // [mgn  ,   16] 증거금                          StartPos 969, Length 16
        public long mnymgn{ get; set; } // [mnymgn  ,   16] 증거금현금                      StartPos 985, Length 16
        public long ordableamt{ get; set; } // [ordableamt  ,   16] 주문가능금액                    StartPos 1001, Length 16
        public long mnyordableamt{ get; set; } // [mnyordableamt  ,   16] 주문가능현금액                  StartPos 1017, Length 16
        public string fnoIsuno_1{ get; set; } // [fnoIsuno_1,    8] 잔고 종목번호1                  StartPos 1033, Length 8
        public string bnstp_1{ get; set; } // [bnstp_1,    1] 잔고 매매구분1                  StartPos 1041, Length 1
        public long unsttqty_1{ get; set; } // [unsttqty_1  ,   16] 미결제수량1                     StartPos 1042, Length 16
        public long lqdtableqty_1{ get; set; } // [lqdtableqty_1  ,   16] 주문가능수량1                   StartPos 1058, Length 16
        public decimal avrprc_1{ get; set; } // [avrprc_1, 13.2] 평균가1                         StartPos 1074, Length 13
        public string fnoIsuno_2{ get; set; } // [fnoIsuno_2,    8] 잔고 종목번호2                  StartPos 1087, Length 8
        public string bnstp_2{ get; set; } // [bnstp_2,    1] 잔고 매매구분2                  StartPos 1095, Length 1
        public long unsttqty_2{ get; set; } // [unsttqty_2  ,   16] 미결제수량2                     StartPos 1096, Length 16
        public long lqdtableqty_2{ get; set; } // [lqdtableqty_2  ,   16] 주문가능수량2                   StartPos 1112, Length 16
        public decimal avrprc_2{ get; set; } // [avrprc_2, 13.2] 평균가2                         StartPos 1128, Length 13
    }
}