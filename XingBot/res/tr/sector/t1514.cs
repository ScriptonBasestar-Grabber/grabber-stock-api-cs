namespace XingBot.real.res
{
    ...
    public struct _t1514OutBlock1
    {
        ...
        public decimal jisu; // [float , 12.2] 지수                            StartPos 9, Length 12
        public string sign; // [string,    1] 전일대비구분                    StartPos 22, Length 1
        public decimal change; // [float ,  7.2] 전일대비                        StartPos 24, Length 7
        public decimal diff; // [float ,  6.2] 등락율                          StartPos 32, Length 6
        public long volume; // [long  ,   12] 거래량                          StartPos 39, Length 12
        public decimal diff_vol; // [float , 12.2] 거래증가율                      StartPos 52, Length 12
        ...
        public decimal uprate; // [float ,  6.2] 상승종목비율                    StartPos 93, Length 6
        public long frgsvolume; // [long  ,    8] 외인순매수                      StartPos 100, Length 8
        public decimal openjisu; // [float , 12.2] 시가                            StartPos 109, Length 12
        public decimal highjisu; // [float , 12.2] 고가                            StartPos 122, Length 12
        public decimal lowjisu; // [float , 12.2] 저가                            StartPos 135, Length 12
        ...
        public decimal rate; // [float ,  7.2] 거래비중                        StartPos 189, Length 7
        public decimal divrate; // [float ,  7.2] 업종배당수익률                  StartPos 197, Length 7
    }
}