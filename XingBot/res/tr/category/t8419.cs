...
namespace XingBot.res.tr.category
{
    ...
    struct _t8419OutBlock1
    {
        ...
        public float high; // [float ,  7.2] 고가                            StartPos 17, Length 7
        public float low; // [float ,  7.2] 저가                            StartPos 25, Length 7
        public float close; // [float ,  7.2] 종가                            StartPos 33, Length 7
