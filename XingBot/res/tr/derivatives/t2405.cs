namespace XingBot.real.res
{
    ...
    {
        public decimal mdvolume; // [double,   12] 매도체결수량                    StartPos 0, Length 12
        public long mdchecnt; // [long  ,    8] 매도체결건수                    StartPos 13, Length 8
        public decimal msvolume; // [double,   12] 매수체결수량                    StartPos 22, Length 12
    ...
    public struct _t2405OutBlock1
    {
        ...
        public decimal price; // [float ,  6.2] 현재가                          StartPos 7, Length 6
        public string sign; // [string,    1] 전일대비구분                    StartPos 14, Length 1
        public decimal change; // [float ,  6.2] 전일대비                        StartPos 16, Length 6
        public decimal volume; // [double,   12] 누적거래량                      StartPos 23, Length 12
        public long cvolume; // [long  ,    8] 체결수량                        StartPos 36, Length 8
        public decimal offerho1; // [float ,  6.2] 매도1호가                       StartPos 45, Length 6
        public decimal bidho1; // [float ,  6.2] 매수1호가                       StartPos 52, Length 6
        ...
        public decimal r_bidrem; // [float ,  6.2] 매수수량비율                    StartPos 131, Length 6
        public decimal r_bidcnt; // [float ,  6.2] 매수건수비율                    StartPos 138, Length 6
