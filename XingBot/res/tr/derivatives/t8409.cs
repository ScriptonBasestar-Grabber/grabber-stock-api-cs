namespace XingBot.res
{
    ...
    {
        public decimal price; // [float ,  6.2] 현재가                          StartPos 0, Length 6
        public string sign; // [string,    1] 전일대비구분                    StartPos 7, Length 1
        public decimal change; // [float ,  6.2] 전일대비                        StartPos 9, Length 6
        public decimal diff; // [float ,  6.2] 등락율                          StartPos 16, Length 6
        public long cvolume; // [long  ,    8] 체결수량                        StartPos 23, Length 8
        public decimal volume; // [double,   15] 누적거래량                      StartPos 32, Length 15
    ...
    public struct _t8409OutBlock1
    {
        ...
        public decimal open; // [float ,  6.2] 시가                            StartPos 15, Length 6
        public decimal high; // [float ,  6.2] 고가                            StartPos 22, Length 6
        public decimal low; // [float ,  6.2] 저가                            StartPos 29, Length 6
        public decimal close; // [float ,  6.2] 종가                            StartPos 36, Length 6
