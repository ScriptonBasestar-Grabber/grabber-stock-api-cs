...
// 선물/옵션 시간대별 체결조회 ( ATTR,BLOCK,HEADTYPE=A )
    ...
    public struct _t2201OutBlock1
    {
        ...
        public decimal chdegree; // [float ,  8.2] 체결강도                        StartPos 36, Length 8
        public decimal offerho; // [float ,  6.2] 매도호가                        StartPos 45, Length 6
        public decimal bidho; // [float ,  6.2] 매수호가                        StartPos 52, Length 6
        public decimal volume; // [double,   12] 거래량                          StartPos 59, Length 12
        public long openyak; // [long  ,    8] 미결수량                        StartPos 72, Length 8
        public long jnilopenupdn; // [long  ,    8] 미결전일증감                    StartPos 81, Length 8
        public decimal ibasis; // [float ,  6.2] 이론BASIS                       StartPos 90, Length 6
        public decimal sbasis; // [float ,  6.2] 시장BASIS                       StartPos 97, Length 6
        public decimal kasis; // [float ,  6.2] 괴리율                          StartPos 104, Length 6
        public decimal value; // [double,   12] 거래대금                        StartPos 111, Length 12
        public long j_openupdn; // [long  ,    8] 미결직전증감                    StartPos 124, Length 8
        public decimal n_msvolume; // [double,   12] 누적매수체결량                  StartPos 133, Length 12
        public decimal n_mdvolume; // [double,   12] 누적매도체결량                  StartPos 146, Length 12
        public decimal s_msvolume; // [double,   12] 누적순매수체결량                StartPos 159, Length 12
