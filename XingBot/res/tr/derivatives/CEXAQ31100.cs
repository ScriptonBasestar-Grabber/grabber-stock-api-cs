namespace XingBot.res
{
    ...
    public struct _CEXAQ31100OutBlock3
    {
        ...
        public decimal FnoAvrPrc; // [FnoAvrPrc, 19.8] 평균가                          StartPos 95, Length 19
        public decimal BasePrc; // [BasePrc,30.10] 기준가                          StartPos 114, Length 30
        public decimal NowPrc; // [NowPrc, 13.2] 현재가                          StartPos 144, Length 13
        public decimal CmpPrc; // [CmpPrc, 13.2] 대비가                          StartPos 157, Length 13
        public long EvalAmt; // [EvalAmt  ,   16] 평가금액                        StartPos 170, Length 16
        public long EvalPnl; // [EvalPnl  ,   16] 평가손익                        StartPos 186, Length 16
        public decimal PnlRat; // [PnlRat, 12.6] 손익률                          StartPos 202, Length 12
