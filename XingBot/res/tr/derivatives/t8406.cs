namespace XingBot.res
{
    ...
    internal struct _t8406OutBlock1
    {
        ...
        public double volume; // [double,   12] 거래량                          StartPos 58, Length 12
        public double value; // [double,   12] 거래대금                        StartPos 71, Length 12
        ...
        public double s_mschevol; // [double,   12] 매수순간체결량                  StartPos 138, Length 12
        public double s_mdchevol; // [double,   12] 매도순간체결량                  StartPos 151, Length 12
        public double ss_mschevol; // [double,   12] 순매수순간체결량                StartPos 164, Length 12
        public float chdegvol; // [float ,  8.2] 체결강도(거래량)                StartPos 177, Length 8
        public float chdegcnt; // [float ,  8.2] 체결강도(건수)                  StartPos 186, Length 8
    }
}