namespace XingBot.real.res
{
    ...
    public struct _CCEAT00200InBlock1
    {
        ...
        public decimal OrdPrc; // [OrdPrc, 15.2] 주문가격                        StartPos 52, Length 15
        public long MdfyQty; // [MdfyQty  ,   16] 정정수량                        StartPos 67, Length 16
    }

    public struct _CCEAT00200OutBlock1
    {
        ...
        public decimal OrdPrc; // [OrdPrc, 15.2] 주문가격                        StartPos 61, Length 15
    ...
    public struct _CCEAT00200OutBlock2
    {
        public long RecCnt; // [RecCnt  ,    5] 레코드갯수                      StartPos 0, Length 5
