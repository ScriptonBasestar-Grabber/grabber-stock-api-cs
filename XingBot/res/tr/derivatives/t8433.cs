namespace XingBot.real.res
{
    ...
    public struct _t8433InBlock
    {
        public string dummy; // [string,    1] Dummy                           StartPos 0, Length 1
    }

    public struct _t8433OutBlock
    {
        ...
        public decimal hprice; // [float ,  6.2] 상한가                          StartPos 40, Length 6
        public decimal lprice; // [float ,  6.2] 하한가                          StartPos 46, Length 6
