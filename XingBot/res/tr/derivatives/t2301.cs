namespace XingBot.res
{
    ...
    public struct _t2301OutBlock
    {
        ...
        public decimal cimpv; // [float ,  6.3] 콜옵션대표IV                    StartPos 10, Length 6
        public decimal pimpv; // [float ,  6.3] 풋옵션대표IV                    StartPos 17, Length 6
        public decimal gmprice; // [float ,  6.2] 근월물현재가                    StartPos 24, Length 6
        public string gmsign; // [string,    1] 근월물전일대비구분              StartPos 31, Length 1
        public decimal gmchange; // [float ,  6.2] 근월물전일대비                  StartPos 33, Length 6
        public decimal gmdiff; // [float ,  6.2] 근월물등락율                    StartPos 40, Length 6
    ...
    public struct _t2301OutBlock1
    {
        ...
        public decimal iv; // [float ,  6.2] IV                              StartPos 52, Length 6
        public long mgjv; // [long  ,   12] 미결제약정                      StartPos 59, Length 12
        public long mgjvupdn; // [long  ,   12] 미결제약정증감                  StartPos 72, Length 12
        public decimal offerho1; // [float ,  6.2] 매도호가                        StartPos 85, Length 6
        public decimal bidho1; // [float ,  6.2] 매수호가                        StartPos 92, Length 6
        public long cvolume; // [long  ,   12] 체결량                          StartPos 99, Length 12
        public decimal delt; // [float ,  6.4] 델타                            StartPos 112, Length 6
        public decimal gama; // [float ,  6.4] 감마                            StartPos 119, Length 6
        public decimal vega; // [float ,  6.4] 베가                            StartPos 126, Length 6
        public decimal ceta; // [float ,  6.4] 쎄타                            StartPos 133, Length 6
        public decimal rhox; // [float ,  6.4] 로우                            StartPos 140, Length 6
        public decimal theoryprice; // [float ,  6.2] 이론가                          StartPos 147, Length 6
        public decimal impv; // [float ,  6.2] 내재가치                        StartPos 154, Length 6
        public decimal timevl; // [float ,  6.2] 시간가치                        StartPos 161, Length 6
        ...
        public decimal open; // [float ,  6.2] 시가                            StartPos 227, Length 6
        public decimal high; // [float ,  6.2] 고가                            StartPos 234, Length 6
        public decimal low; // [float ,  6.2] 저가                            StartPos 241, Length 6
        public string atmgubun; // [string,    1] ATM구분                         StartPos 248, Length 1
        public decimal jisuconv; // [float ,  6.2] 지수환산                        StartPos 250, Length 6
        public decimal value; // [float ,   12] 거래대금                        StartPos 257, Length 12
    }
