namespace XingBot.res
{
    ...
    public struct _CEXAT11100InBlock1
    {
        ...
        public decimal OrdPrc; // [OrdPrc, 15.2] 주문가격                        StartPos 42, Length 15
    ...
    public struct _CEXAT11100OutBlock1
    {
        ...
        public decimal OrdPrc; // [OrdPrc, 15.2] 주문가격                        StartPos 47, Length 15
        public long OrdQty; // [OrdQty  ,   16] 주문수량                        StartPos 62, Length 16
        public decimal OrdCndiPrc; // [OrdCndiPrc, 25.8] 주문조건가격                    StartPos 78, Length 25
