namespace XingBot.res
{
    ...
    public struct _t2831OutBlock
    {
        ...
        public decimal jnilclose; // [float ,  6.2] 전일종가                        StartPos 57, Length 6
        public decimal offerho1; // [float ,  6.2] 매도호가1                       StartPos 64, Length 6
        public decimal bidho1; // [float ,  6.2] 매수호가1                       StartPos 71, Length 6
        ...
        public decimal offerho2; // [float ,  6.2] 매도호가2                       StartPos 114, Length 6
        public decimal bidho2; // [float ,  6.2] 매수호가2                       StartPos 121, Length 6
        ...
        public decimal offerho3; // [float ,  6.2] 매도호가3                       StartPos 164, Length 6
        public decimal bidho3; // [float ,  6.2] 매수호가3                       StartPos 171, Length 6
        ...
        public decimal offerho4; // [float ,  6.2] 매도호가4                       StartPos 214, Length 6
        public decimal bidho4; // [float ,  6.2] 매수호가4                       StartPos 221, Length 6
        ...
        public decimal offerho5; // [float ,  6.2] 매도호가5                       StartPos 264, Length 6
        public decimal bidho5; // [float ,  6.2] 매수호가5                       StartPos 271, Length 6
