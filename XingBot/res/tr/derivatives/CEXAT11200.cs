namespace XingBot.real.res
{
    ...
    public struct _CEXAT11200InBlock1
    {
        ...
        public decimal OrdPrc; // [OrdPrc, 15.2] 주문가격                        StartPos 50, Length 15
    }

    public struct _CEXAT11200OutBlock1
    {
        ...
        public decimal OrdPrc; // [OrdPrc, 15.2] 주문가격                        StartPos 57, Length 15
        public long MdfyQty; // [MdfyQty  ,   16] 정정수량                        StartPos 72, Length 16
        public decimal OrdCndiPrc; // [OrdCndiPrc, 25.8] 주문조건가격                    StartPos 88, Length 25
        public string CommdaCode; // [CommdaCode,    2] 통신매체코드                    StartPos 113, Length 2
    }

    public struct _CEXAT11200OutBlock2
    {
        public long RecCnt; // [RecCnt  ,    5] 레코드갯수                      StartPos 0, Length 5
