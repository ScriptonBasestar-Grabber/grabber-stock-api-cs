namespace XingBot.real.res
{
    ...
    public struct _t0441OutBlock1
    {
        ...
        public decimal pamt; // [float , 10.2] 평균단가                        StartPos 36, Length 10
        ...
        public decimal price; // [float ,  9.2] 현재가                          StartPos 98, Length 9
        public long appamt; // [long  ,   18] 평가금액                        StartPos 108, Length 18
        public long dtsunik1; // [long  ,   18] 평가손익                        StartPos 127, Length 18
        public decimal sunikrt; // [float , 10.2] 수익율                          StartPos 146, Length 10
    }
}