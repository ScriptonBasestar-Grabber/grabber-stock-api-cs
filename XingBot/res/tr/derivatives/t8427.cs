namespace XingBot.res
{
    ...
    internal struct _t8427InBlock
    {
        ...
        public float actprice; // [float ,  6.2] 옵션행사가                      StartPos 12, Length 6
    ...
    internal struct _t8427OutBlock
    {
    ...
    internal struct _t8427OutBlock1
    {
        public string date; // [string,    8] 날짜                            StartPos 0, Length 8
        public string time; // [string,    6] 시간                            StartPos 9, Length 6
        public float open; // [float ,  6.2] 시가                            StartPos 16, Length 6
        public float high; // [float ,  6.2] 고가                            StartPos 23, Length 6
        public float low; // [float ,  6.2] 저가                            StartPos 30, Length 6
        public float close; // [float ,  6.2] 종가                            StartPos 37, Length 6
        public string sign; // [string,    1] 전일대비구분                    StartPos 44, Length 1
        public float change; // [float ,  6.2] 전일대비                        StartPos 46, Length 6
        public float diff; // [float ,  6.2] 등락율                          StartPos 53, Length 6
        public long volume; // [long  ,   12] 거래량                          StartPos 60, Length 12
        public float diff_vol; // [float , 10.2] 거래증가율                      StartPos 73, Length 10
        public long openyak; // [long  ,    8] 미결수량                        StartPos 84, Length 8
        public long openyakupdn; // [long  ,    8] 미결증감                        StartPos 93, Length 8
        public float value; // [float ,   12] 거래대금                        StartPos 102, Length 12
    }
}