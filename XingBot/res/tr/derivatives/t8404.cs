namespace XingBot.res
{
    ...
    internal struct _t8404OutBlock
    {
        public string cts_time; // [string,   10] 시간CTS                         StartPos 0, Length 10
    }

    internal struct _t8404OutBlock1
    {
        ...
        public float change; // [float ,    8] 전일대비                        StartPos 22, Length 8
        public long cvolume; // [long  ,    8] 체결수량                        StartPos 31, Length 8
        public float chdegree; // [float ,  8.2] 체결강도                        StartPos 40, Length 8
        public long offerho; // [long  ,    8] 매도호가                        StartPos 49, Length 8
        public long bidho; // [long  ,    8] 매수호가                        StartPos 58, Length 8
        public double volume; // [double,   12] 거래량                          StartPos 67, Length 12
        ...
        public float kasis; // [float ,  6.2] 괴리율                          StartPos 116, Length 6
        public double value; // [double,   12] 거래대금                        StartPos 123, Length 12
        public long j_openupdn; // [long  ,    8] 미결직전증감                    StartPos 136, Length 8
        public double n_msvolume; // [double,   12] 누적매수체결량                  StartPos 145, Length 12
        public double n_mdvolume; // [double,   12] 누적매도체결량                  StartPos 158, Length 12
        public double s_msvolume; // [double,   12] 누적순매수체결량                StartPos 171, Length 12
