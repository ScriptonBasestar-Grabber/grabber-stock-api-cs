namespace XingBot.res
{
    ...
    internal struct _MMDAQ91200OutBlock2
    {
        ...
        public double CsgnMgnrt; // [CsgnMgnrt, 26.9] 위탁증거금율                    StartPos 125, Length 26
        public double MaintMgnrt; // [MaintMgnrt, 26.9] 유지증거금율                    StartPos 151, Length 26
        public double MnyMgnrt; // [MnyMgnrt, 26.9] 현금증거금율                    StartPos 177, Length 26
