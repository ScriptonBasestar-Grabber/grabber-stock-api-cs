...
{
    // 선물옵션 정상주문 ( SERVICE=CFOAT00100,ENCRYPT,SIGNATURE,HEADTYPE=B,CREATOR=이인희,CREDATE=2012/03/12 13:31:10 )
    public struct _CFOAT00100InBlock1
    {
        ...
        public decimal OrdPrc; // [OrdPrc, 15.2] 주문가격                        StartPos 43, Length 15
        public long OrdQty; // [OrdQty  ,   16] 주문수량                        StartPos 58, Length 16
    }

    public struct _CFOAT00100OutBlock1
    {
        ...
        public decimal OrdPrc; // [OrdPrc, 15.2] 주문가격                        StartPos 54, Length 15
    ...
    public struct _CFOAT00100OutBlock2
    {
        public long RecCnt; // [RecCnt  ,    5] 레코드갯수                      StartPos 0, Length 5
