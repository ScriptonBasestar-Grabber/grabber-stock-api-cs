namespace XingBot.res.tr_derivatives
{
    ...
    internal struct _CCEAQ01100OutBlock3
    {
        ...
        public double BgnCtrctIdxExecPrc; // [BgnCtrctIdxExecPrc, 13.2] 당초약정지수체결가              StartPos 101, Length 13
        public long BgnAmt; // [BgnAmt  ,   16] 당초금액                        StartPos 114, Length 16
        public long CtrctQty; // [CtrctQty  ,   16] 약정수량                        StartPos 130, Length 16
        public double ExecPrc; // [ExecPrc, 13.2] 체결가                          StartPos 146, Length 13
