namespace XingBot.res
{
    ...
    public struct _t8402InBlock
    {
        public string focode; // [string,    8] 단축코드                        StartPos 0, Length 8
    }

    public struct _t8402OutBlock
    {
        ...
        public decimal diff; // [float ,  6.2] 등락율                          StartPos 50, Length 6
        public long volume; // [long  ,   12] 거래량                          StartPos 57, Length 12
        public decimal stimeqrt; // [double,  6.2] 거래량전일동시간비율            StartPos 70, Length 6
        ...
        public decimal basis; // [float ,  6.2] 베이시스                        StartPos 171, Length 6
        public long recprice; // [long  ,    8] 기준가                          StartPos 178, Length 8
        public long theoryprice; // [long  ,    8] 이론가                          StartPos 187, Length 8
        public decimal glyl; // [float ,  6.3] 괴리율                          StartPos 196, Length 6
        public string lastmonth; // [string,    8] 만기일                          StartPos 203, Length 8
        public long jandatecnt; // [long  ,    8] 잔여일                          StartPos 212, Length 8
        public decimal pricejisu; // [float ,  6.2] 종합지수                        StartPos 221, Length 6
        public string jisusign; // [string,    1] 종합지수전일대비구분            StartPos 228, Length 1
        public decimal jisuchange; // [float ,  6.2] 종합지수전일대비                StartPos 230, Length 6
        public decimal jisudiff; // [float ,  6.2] 종합지수등락율                  StartPos 237, Length 6
        public decimal kospijisu; // [float ,  6.2] KOSPI200지수                    StartPos 244, Length 6
        public string kospisign; // [string,    1] KOSPI200전일대비구분            StartPos 251, Length 1
        public decimal kospichange; // [float ,  6.2] KOSPI200전일대비                StartPos 253, Length 6
        public decimal kospidiff; // [float ,  6.2] KOSPI200등락율                  StartPos 260, Length 6
        public long listhprice; // [long  ,    8] 상장최고가                      StartPos 267, Length 8
        public long listlprice; // [long  ,    8] 상장최저가                      StartPos 276, Length 8
        public decimal delt; // [float ,  6.4] 델타                            StartPos 285, Length 6
        public decimal gama; // [float ,  6.4] 감마                            StartPos 292, Length 6
        public decimal ceta; // [float ,  6.4] 세타                            StartPos 299, Length 6
        public decimal vega; // [float ,  6.4] 베가                            StartPos 306, Length 6
        public decimal rhox; // [float ,  6.4] 로우                            StartPos 313, Length 6
        ...
        public decimal gmdiff; // [float ,  6.2] 근월물등락율                    StartPos 340, Length 6
        public long theorypriceg; // [long  ,    8] 이론가                          StartPos 347, Length 8
        public decimal histimpv; // [float ,  6.2] 역사적변동성                    StartPos 356, Length 6
        public decimal impv; // [float ,  6.2] 내재변동성                      StartPos 363, Length 6
        ...
        public decimal basediff; // [float ,  6.2] 기초자산등락률                  StartPos 454, Length 6
        ...
        public decimal mulcnt; // [float , 12.8] 승수                            StartPos 541, Length 12
        ...
        public decimal jnilydrate; // [float ,  6.2] 예상체결가전일종가등락율        StartPos 576, Length 6
    }
}