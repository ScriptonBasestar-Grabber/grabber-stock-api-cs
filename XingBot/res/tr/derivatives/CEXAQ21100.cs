namespace XingBot.res
{
    ...
    public struct _CEXAQ21100OutBlock3
    {
        ...
        public decimal OrdCndiPrc; // [OrdCndiPrc, 25.8] 주문조건가격                    StartPos 171, Length 25
        public decimal OrdPrc; // [OrdPrc, 13.2] 주문가                          StartPos 196, Length 13
        public long OrdQty; // [OrdQty  ,   16] 주문수량                        StartPos 209, Length 16
        public string OrdTpNm; // [OrdTpNm,   10] 주문구분명                      StartPos 225, Length 10
        public decimal ExecPrc; // [ExecPrc, 13.2] 체결가                          StartPos 235, Length 13
