...
namespace XingBot.res.tr.derivatives
{
    ...
    struct _t2804OutBlock1
    {
        ...
        public float price; // [float ,  6.2] 현재가                          StartPos 22, Length 6
        public string sign; // [string,    1] 전일대비구분                    StartPos 29, Length 1
        public float change; // [float ,  6.2] 전일대비                        StartPos 31, Length 6
        public long cvolume; // [long  ,    8] 체결수량                        StartPos 38, Length 8
        public float chdegree; // [float ,  8.2] 체결강도                        StartPos 47, Length 8
        public float offerho; // [float ,  6.2] 매도호가                        StartPos 56, Length 6
        public float bidho; // [float ,  6.2] 매수호가                        StartPos 63, Length 6
        public double volume; // [double,   12] 거래량                          StartPos 70, Length 12
        public long openyak; // [long  ,    8] 미결수량                        StartPos 83, Length 8
        public long jnilopenupdn; // [long  ,    8] 미결전일증감                    StartPos 92, Length 8
        public float ibasis; // [float ,  6.2] 이론BASIS                       StartPos 101, Length 6
        public float sbasis; // [float ,  6.2] 시장BASIS                       StartPos 108, Length 6
        public float kasis; // [float ,  6.2] 괴리율                          StartPos 115, Length 6
        public double value; // [double,   12] 거래대금                        StartPos 122, Length 12
        public long j_openupdn; // [long  ,    8] 미결직전증감                    StartPos 135, Length 8
        public double n_msvolume; // [double,   12] 누적매수체결량                  StartPos 144, Length 12
        public double n_mdvolume; // [double,   12] 누적매도체결량                  StartPos 157, Length 12
        public double s_msvolume; // [double,   12] 누적순매수체결량                StartPos 170, Length 12
