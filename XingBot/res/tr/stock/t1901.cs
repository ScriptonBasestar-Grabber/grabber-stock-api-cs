namespace XingBot.res.tr
{
    ...
    internal struct _t1901InBlock
    {
        public string shcode; // [string,    6] 단축코드                        StartPos 0, Length 6
    }

    internal struct _t1901OutBlock
    {
        ...
        public float volume; // [float ,   12] 누적거래량                      StartPos 48, Length 12
        ...
        public float jnilvolume; // [float ,   12] 전일거래량                      StartPos 97, Length 12
        ...
        public float flmtvol; // [float ,   12] 외국인보유수량                  StartPos 214, Length 12
        public float per; // [float ,  6.2] PER                             StartPos 227, Length 6
        public long listing; // [long  ,   12] 상장주식수(천)                  StartPos 234, Length 12
        public long jkrate; // [long  ,    8] 증거금율                        StartPos 247, Length 8
        public float vol; // [float ,  6.2] 회전율                          StartPos 256, Length 6
        ...
        public float upprice; // [float ,  7.2] 업종현재가                      StartPos 344, Length 7
        public string upsign; // [string,    1] 업종전일비구분                  StartPos 352, Length 1
        public float upchange; // [float ,  6.2] 업종전일대비                    StartPos 354, Length 6
        public float updiff; // [float ,  6.2] 업종등락율                      StartPos 361, Length 6
        ...
        public float futprice; // [float ,  6.2] 선물현재가                      StartPos 398, Length 6
        public string futsign; // [string,    1] 선물전일비구분                  StartPos 405, Length 1
        public float futchange; // [float ,  6.2] 선물전일대비                    StartPos 407, Length 6
        public float futdiff; // [float ,  6.2] 선물등락율                      StartPos 414, Length 6
        public float nav; // [float ,  8.2] NAV                             StartPos 421, Length 8
        public string navsign; // [string,    1] NAV전일대비구분                 StartPos 430, Length 1
        public float navchange; // [float ,  8.2] NAV전일대비                     StartPos 432, Length 8
        public float navdiff; // [float ,  6.2] NAV등락율                       StartPos 441, Length 6
        public float cocrate; // [float ,  6.2] 추적오차율                      StartPos 448, Length 6
        public float kasis; // [float ,  6.2] 괴리율                          StartPos 455, Length 6
        ...
        public float ddiff1; // [float ,  6.2] 매도비율1                       StartPos 523, Length 6
        public float sdiff1; // [float ,  6.2] 매수비율1                       StartPos 530, Length 6
        ...
        public float ddiff2; // [float ,  6.2] 매도비율2                       StartPos 587, Length 6
        public float sdiff2; // [float ,  6.2] 매수비율2                       StartPos 594, Length 6
        ...
        public float ddiff3; // [float ,  6.2] 매도비율3                       StartPos 651, Length 6
        public float sdiff3; // [float ,  6.2] 매수비율3                       StartPos 658, Length 6
        ...
        public float ddiff4; // [float ,  6.2] 매도비율4                       StartPos 715, Length 6
        public float sdiff4; // [float ,  6.2] 매수비율4                       StartPos 722, Length 6
        ...
        public float ddiff5; // [float ,  6.2] 매도비율5                       StartPos 779, Length 6
        public float sdiff5; // [float ,  6.2] 매수비율5                       StartPos 786, Length 6
        ...
        public float ftradmddiff; // [float ,  6.2] 외국계매도비율                  StartPos 819, Length 6
        ...
        public float ftradmsdiff; // [float ,  6.2] 외국계매수비율                  StartPos 852, Length 6
        public string upname2; // [string,   20] 참고지수명                      StartPos 859, Length 20
        public string upcode2; // [string,    3] 참고지수코드                    StartPos 880, Length 3
        public float upprice2; // [float ,  7.2] 참고지수현재가                  StartPos 884, Length 7
        public float jnilnav; // [float ,  8.2] 전일NAV                         StartPos 892, Length 8
        public string jnilnavsign; // [string,    1] 전일NAV전일대비구분             StartPos 901, Length 1
        public float jnilnavchange; // [float ,  8.2] 전일NAV전일대비                 StartPos 903, Length 8
        public float jnilnavdiff; // [float ,  6.2] 전일NAV등락율                   StartPos 912, Length 6
        public long etftotcap; // [long  ,   12] 순자산총액(억원)                StartPos 919, Length 12
        public float spread; // [float ,  6.2] 스프레드                        StartPos 932, Length 6
