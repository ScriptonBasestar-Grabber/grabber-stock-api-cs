namespace XingBot.res.tr
{
    ...
    internal struct _CLNAQ00100InBlock1
    {
    ...
    internal struct _CLNAQ00100OutBlock1
    {
        public long RecCnt; // [RecCnt  ,    5] 레코드갯수                      StartPos 0, Length 5
        public string QryTp; // [QryTp,    1] 조회구분                        StartPos 5, Length 1
        public string IsuNo; // [IsuNo,   12] 종목번호                        StartPos 6, Length 12
    ...
    internal struct _CLNAQ00100OutBlock2
    {
        public string IsuNo; // [IsuNo,   12] 종목번호                        StartPos 0, Length 12
        public string IsuNm; // [IsuNm,   40] 종목명                          StartPos 12, Length 40
        public double Parprc; // [Parprc, 13.2] 액면가                          StartPos 52, Length 13
        public double PrdayCprc; // [PrdayCprc, 13.2] 전일종가                        StartPos 65, Length 13
        public double RatVal; // [RatVal, 19.8] 비율값                          StartPos 78, Length 19
        public double SubstPrc; // [SubstPrc, 13.2] 대용가                          StartPos 97, Length 13
        ...
        public double LoanAbleRat; // [LoanAbleRat, 26.9] 대출가능율                      StartPos 364, Length 26
        public double LoanIntrat1; // [LoanIntrat1, 14.4] 대출이율1                       StartPos 390, Length 14
        public string RegPsnId; // [RegPsnId,   16] 등록자ID                        StartPos 404, Length 16
        public double Rat01; // [Rat01, 19.8] 비율값                          StartPos 420, Length 19
        public double Rat02; // [Rat02, 19.8] 비율값                          StartPos 439, Length 19
    }

    internal struct _CLNAQ00100OutBlock3
    {
        public long RecCnt; // [RecCnt  ,    5] 레코드갯수                      StartPos 0, Length 5
