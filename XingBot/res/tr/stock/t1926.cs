...
namespace XingBot.res.tr
{
    ...
    struct _t1926OutBlock
    {
        ...
        public float ygrate; // [float ,  9.2] 융자공여율                      StartPos 36, Length 9
        public float yjrate; // [float ,  9.2] 융자잔고율                      StartPos 46, Length 9
        ...
        public float dgrate; // [float ,  9.2] 대주공여율                      StartPos 128, Length 9
        public float djrate; // [float ,  9.2] 대주잔고율                      StartPos 138, Length 9
        ...
        public float pr5days; // [float ,  9.2] 주가5일증가율                   StartPos 226, Length 9
        public float pr20days; // [float ,  9.2] 주가20일증가율                  StartPos 236, Length 9
        public float yj5days; // [float ,  9.2] 융자5일증가율                   StartPos 246, Length 9
        public float yj20days; // [float ,  9.2] 융자20일증가율                  StartPos 256, Length 9
        public float dj5days; // [float ,  9.2] 대주5일증가율                   StartPos 266, Length 9
        public float dj20days; // [float ,  9.2] 대주20일증가율                  StartPos 276, Length 9
    }
}