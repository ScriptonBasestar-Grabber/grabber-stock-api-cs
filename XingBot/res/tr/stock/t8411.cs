namespace XingBot.res
{
    ...
    public class _t8411InBlock
    {
        public string shcode { get; set; } //[string,    6] 단축코드                        StartPos 0, Length 6
        public long ncnt { get; set; } //[long  ,    4] 단위(n틱)                       StartPos 7, Length 4
    ...
    public class _t8411OutBlock1
    {
        ...
        public long jongchk { get; set; } //[long  ,   13] 수정구분                        StartPos 69, Length 13
        public decimal rate { get; set; } //[double,  6.2] 수정비율                        StartPos 83, Length 6
        public long pricechk { get; set; } //[long  ,   13] 수정주가반영항목                StartPos 90, Length 13
    }
}