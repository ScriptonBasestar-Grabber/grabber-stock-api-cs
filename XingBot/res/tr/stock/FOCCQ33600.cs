namespace XingBot.real.res.tr
{
    ...
    public struct _FOCCQ33600InBlock1
    {
    ...
    public struct _FOCCQ33600OutBlock1
    {
        public long RecCnt; // [RecCnt  ,    5] 레코드갯수                      StartPos 0, Length 5
        public string AcntNo; // [AcntNo,   20] 계좌번호                        StartPos 5, Length 20
        public string Pwd; // [Pwd,    8] 비밀번호                        StartPos 25, Length 8
    ...
    public struct _FOCCQ33600OutBlock2
    {
        public long RecCnt; // [RecCnt  ,    5] 레코드갯수                      StartPos 0, Length 5
        ...
        public decimal InvstErnrat; // [InvstErnrat,  9.2] 투자수익률                      StartPos 125, Length 9
    }

    public struct _FOCCQ33600OutBlock3
    {
        ...
        public decimal TermErnrat; // [TermErnrat, 11.3] 기간수익률                      StartPos 126, Length 11
        public decimal Idx; // [Idx, 13.2] 지수                            StartPos 137, Length 13
    }
}