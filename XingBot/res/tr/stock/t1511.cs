namespace XingBot.res
{
    ...
    public struct _t1511OutBlock
    {
        ...
        public decimal pricejisu; // [float ,  7.2] 현재지수                        StartPos 23, Length 7
        public decimal jniljisu; // [float ,  7.2] 전일지수                        StartPos 31, Length 7
        public string sign; // [string,    1] 전일대비구분                    StartPos 39, Length 1
        public decimal change; // [float ,  7.2] 전일대비                        StartPos 41, Length 7
        public decimal diffjisu; // [float ,  6.2] 지수등락율                      StartPos 49, Length 6
        ...
        public decimal volumerate; // [float ,  6.2] 거래량비율                      StartPos 95, Length 6
        ...
        public decimal valuerate; // [float ,  6.2] 거래대금비율                    StartPos 141, Length 6
        public decimal openjisu; // [float ,  7.2] 시가지수                        StartPos 148, Length 7
        public decimal opendiff; // [float ,  6.2] 시가등락율                      StartPos 156, Length 6
        public string opentime; // [string,    6] 시가시간                        StartPos 163, Length 6
        public decimal highjisu; // [float ,  7.2] 고가지수                        StartPos 170, Length 7
        public decimal highdiff; // [float ,  6.2] 고가등락율                      StartPos 178, Length 6
        public string hightime; // [string,    6] 고가시간                        StartPos 185, Length 6
        public decimal lowjisu; // [float ,  7.2] 저가지수                        StartPos 192, Length 7
        public decimal lowdiff; // [float ,  6.2] 저가등락율                      StartPos 200, Length 6
        public string lowtime; // [string,    6] 저가시간                        StartPos 207, Length 6
        public decimal whjisu; // [float ,  7.2] 52주최고지수                    StartPos 214, Length 7
        public decimal whchange; // [float ,  7.2] 52주최고현재가대비              StartPos 222, Length 7
        public string whjday; // [string,    8] 52주최고지수일자                StartPos 230, Length 8
        public decimal wljisu; // [float ,  7.2] 52주최저지수                    StartPos 239, Length 7
        public decimal wlchange; // [float ,  7.2] 52주최저현재가대비              StartPos 247, Length 7
        public string wljday; // [string,    8] 52주최저지수일자                StartPos 255, Length 8
        public decimal yhjisu; // [float ,  7.2] 연중최고지수                    StartPos 264, Length 7
        public decimal yhchange; // [float ,  7.2] 연중최고현재가대비              StartPos 272, Length 7
        public string yhjday; // [string,    8] 연중최고지수일자                StartPos 280, Length 8
        public decimal yljisu; // [float ,  7.2] 연중최저지수                    StartPos 289, Length 7
        public decimal ylchange; // [float ,  7.2] 연중최저현재가대비              StartPos 297, Length 7
        ...
        public decimal firstjisu; // [float ,  7.2] 첫번째지수                      StartPos 339, Length 7
        public string firsign; // [string,    1] 첫번째대비구분                  StartPos 347, Length 1
        public decimal firchange; // [float ,  7.2] 첫번째전일대비                  StartPos 349, Length 7
        public decimal firdiff; // [float ,  6.2] 첫번째등락율                    StartPos 357, Length 6
        ...
        public decimal secondjisu; // [float ,  7.2] 두번째지수                      StartPos 389, Length 7
        public string secsign; // [string,    1] 두번째대비구분                  StartPos 397, Length 1
        public decimal secchange; // [float ,  7.2] 두번째전일대비                  StartPos 399, Length 7
        public decimal secdiff; // [float ,  6.2] 두번째등락율                    StartPos 407, Length 6
        ...
        public decimal thirdjisu; // [float ,  7.2] 세번째지수                      StartPos 439, Length 7
        public string thrsign; // [string,    1] 세번째대비구분                  StartPos 447, Length 1
        public decimal thrchange; // [float ,  7.2] 세번째전일대비                  StartPos 449, Length 7
        public decimal thrdiff; // [float ,  6.2] 세번째등락율                    StartPos 457, Length 6
        ...
        public decimal fourthjisu; // [float ,  7.2] 네번째지수                      StartPos 489, Length 7
        public string forsign; // [string,    1] 네번째대비구분                  StartPos 497, Length 1
        public decimal forchange; // [float ,  7.2] 네번째전일대비                  StartPos 499, Length 7
        public decimal fordiff; // [float ,  6.2] 네번째등락율                    StartPos 507, Length 6
