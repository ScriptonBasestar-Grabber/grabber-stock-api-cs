namespace XingBot.res.tr
{
    ...
    internal struct _t1422OutBlock1
    {
        ...
        public float diff_vol; // [float , 10.2] 거래증가율                      StartPos 61, Length 10
