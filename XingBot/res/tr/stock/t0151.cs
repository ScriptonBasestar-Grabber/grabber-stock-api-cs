...
namespace XingBot.res.tr
{
    ...
    struct _t0151InBlock
    {
        ...
        public string cts_medosu; // [cts_medosu,    1] CTS_매매구분                    StartPos 19, Length 1
        public string cts_expcode; // [cts_expcode,   12] CTS_종목번호                    StartPos 20, Length 12
        public string cts_price; // [cts_price,    9] CTS_단가                        StartPos 32, Length 9
