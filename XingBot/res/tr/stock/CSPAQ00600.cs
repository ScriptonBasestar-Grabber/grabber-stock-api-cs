namespace XingBot.real.res.tr
{
    ...
    public struct _CSPAQ00600InBlock1
    {
        ...
        public decimal OrdPrc; // [OrdPrc, 13.2] 주문가                          StartPos 47, Length 13
    ...
    public struct _CSPAQ00600OutBlock2
    {
        ...
        public decimal OrdPrc; // [OrdPrc, 13.2] 주문가                          StartPos 45, Length 13
        ...
        public decimal PldgMaintRat; // [PldgMaintRat,  7.4] 담보유지비율                    StartPos 380, Length 7
        public string FirmNm; // [FirmNm,   50] 이용사명                        StartPos 387, Length 50
        public decimal PldgRat; // [PldgRat,  7.4] 담보비율                        StartPos 437, Length 7
