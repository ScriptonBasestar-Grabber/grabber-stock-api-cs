namespace XingBot.res
{
    ...
    public struct _t1485InBlock
    {
        public string upcode; // [string,    3] 업종코드                        StartPos 0, Length 3
        public string gubun; // [string,    1] 조회구분                        StartPos 4, Length 1
    }

    public struct _t1485OutBlock
    {
        public decimal pricejisu; // [float , 10.2] 현재지수                        StartPos 0, Length 10
        public string sign; // [string,    1] 지수전일대비구분                StartPos 11, Length 1
        public decimal change; // [float , 10.2] 전일대비                        StartPos 13, Length 10
    ...
    public struct _t1485OutBlock1
    {
        public string chetime; // [string,    6] 시간                            StartPos 0, Length 6
        public decimal jisu; // [float , 10.2] 예상지수                        StartPos 7, Length 10
        public string sign; // [string,    1] 전일대비구분                    StartPos 18, Length 1
        public decimal change; // [float , 10.2] 전일대비                        StartPos 20, Length 10
