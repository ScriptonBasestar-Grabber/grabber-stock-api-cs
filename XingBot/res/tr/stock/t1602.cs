namespace XingBot.res
{
    ...
    public struct _t1602InBlock
    {
        ...
        public string gubun1{ get; set; } // [string,    1] 수량구분                        StartPos 6, Length 1
        public string gubun2{ get; set; } // [string,    1] 전일분구분                      StartPos 8, Length 1
        public string cts_time{ get; set; } // [string,    8] CTSTIME                         StartPos 10, Length 8
        public long cts_idx{ get; set; } // [long  ,    4] CTSIDX                          StartPos 19, Length 4
        public string cnt{ get; set; } // [string,    4] 조회건수                        StartPos 24, Length 4
