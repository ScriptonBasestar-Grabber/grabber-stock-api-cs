namespace XingBot.res
{
    ...
    public struct _t1444OutBlock1
    {
        ...
        public decimal diff; // [float ,  6.2] 등락율                          StartPos 48, Length 6
        public long volume; // [long  ,   12] 거래량                          StartPos 55, Length 12
        public decimal vol_rate; // [float ,  6.2] 거래비중                        StartPos 68, Length 6
        public long total; // [long  ,   12] 시가총액                        StartPos 75, Length 12
        public decimal rate; // [float ,  6.2] 비중                            StartPos 88, Length 6
        public decimal for_rate; // [float ,  6.2] 외인비중                        StartPos 95, Length 6
    }
}