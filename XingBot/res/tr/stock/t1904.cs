...
namespace XingBot.res.tr
{
    ...
    struct _t1904OutBlock
    {
        ...
        public float diff; // [float ,  6.2] ETF등락율                       StartPos 31, Length 6
        public long volume; // [long  ,   12] ETF누적거래량                   StartPos 38, Length 12
        public float nav; // [float ,  8.2] NAV                             StartPos 51, Length 8
        public string navsign; // [string,    1] NAV전일대비구분                 StartPos 60, Length 1
        public float navchange; // [float ,  8.2] NAV전일대비                     StartPos 62, Length 8
        public float navdiff; // [float ,  6.2] NAV등락율                       StartPos 71, Length 6
        public float jnilnav; // [float ,  8.2] 전일NAV                         StartPos 78, Length 8
        public string jnilnavsign; // [string,    1] 전일NAV전일대비구분             StartPos 87, Length 1
        public float jnilnavchange; // [float ,  8.2] 전일NAV전일대비                 StartPos 89, Length 8
        public float jnilnavdiff; // [float ,  6.2] 전일NAV등락율                   StartPos 98, Length 6
        public string upname; // [string,   20] 업종명                          StartPos 105, Length 20
        public string upcode; // [string,    3] 업종코드                        StartPos 126, Length 3
        public float upprice; // [float ,  7.2] 업종현재가                      StartPos 130, Length 7
        public string upsign; // [string,    1] 업종전일비구분                  StartPos 138, Length 1
        public float upchange; // [float ,  6.2] 업종전일대비                    StartPos 140, Length 6
        public float updiff; // [float ,  6.2] 업종등락율                      StartPos 147, Length 6
        ...
        public float futprice; // [float ,  6.2] 선물현재가                      StartPos 184, Length 6
        public string futsign; // [string,    1] 선물전일비구분                  StartPos 191, Length 1
        public float futchange; // [float ,  6.2] 선물전일대비                    StartPos 193, Length 6
        public float futdiff; // [float ,  6.2] 선물등락율                      StartPos 200, Length 6
        public string upname2; // [string,   20] 참고지수명                      StartPos 207, Length 20
        public string upcode2; // [string,    3] 참고지수코드                    StartPos 228, Length 3
        public float upprice2; // [float ,  7.2] 참고지수현재가                  StartPos 232, Length 7
    ...
    struct _t1904OutBlock1
    {
        ...
        public float weight; // [float ,  6.2] 비중(평가금액)                  StartPos 148, Length 6
        public float diff2; // [float ,  6.2] ETF종목과등락차                 StartPos 155, Length 6
    }
}