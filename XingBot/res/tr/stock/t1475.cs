namespace XingBot.real.res.tr
{
    ...
    public struct _t1475OutBlock1
    {
        ...
        public decimal diff; // [float ,  6.2] 등락율                          StartPos 31, Length 6
        public long volume; // [long  ,   12] 거래량                          StartPos 38, Length 12
        public decimal todayvp; // [float ,  8.2] 당일VP                          StartPos 51, Length 8
        public decimal ma5vp; // [float ,  8.2] 5일MAVP                         StartPos 60, Length 8
        public decimal ma20vp; // [float ,  8.2] 20일MAVP                        StartPos 69, Length 8
        public decimal ma60vp; // [float ,  8.2] 60일MAVP                        StartPos 78, Length 8
    }
}