namespace XingBot.res
{
    ...
    public struct _t1621InBlock
    {
        ...
        public string cnt{ get; set; } // [string,    3] 조회건수                        StartPos 7, Length 3
    ...
    public struct _t1621OutBlock
    {
        ...
        public string syscode{ get; set; } // [string,    4] 기관계투자자코드                StartPos 10, Length 4
        public string stocode{ get; set; } // [string,    4] 증권투자자코드                  StartPos 15, Length 4
        public string invcode{ get; set; } // [string,    4] 투신투자자코드                  StartPos 20, Length 4
        public string bancode{ get; set; } // [string,    4] 은행투자자코드                  StartPos 25, Length 4
        public string inscode{ get; set; } // [string,    4] 보험투자자코드                  StartPos 30, Length 4
        public string fincode{ get; set; } // [string,    4] 종금투자자코드                  StartPos 35, Length 4
        public string moncode{ get; set; } // [string,    4] 기금투자자코드                  StartPos 40, Length 4
        public string etccode{ get; set; } // [string,    4] 기타투자자코드                  StartPos 45, Length 4
        public string natcode{ get; set; } // [string,    4] 국가투자자코드                  StartPos 50, Length 4
        public string pefcode{ get; set; } // [string,    4] 사모펀드투자자코드              StartPos 55, Length 4
        public string jisucd{ get; set; } // [string,    8] 기준지수코드                    StartPos 60, Length 8
