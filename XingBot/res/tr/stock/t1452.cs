namespace XingBot.res.tr
{
    ...
    internal struct _t1452OutBlock
    {
        public long idx; // [long  ,    4] IDX                             StartPos 0, Length 4
    }

    internal struct _t1452OutBlock1
    {
        ...
        public float vol; // [float ,  6.2] 회전율                          StartPos 61, Length 6
        public long jnilvolume; // [long  ,   12] 전일거래량                      StartPos 68, Length 12
        public float bef_diff; // [float , 10.2] 전일비                          StartPos 81, Length 10
