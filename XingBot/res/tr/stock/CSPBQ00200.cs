namespace XingBot.res.tr
{
    ...
    internal struct _CSPBQ00200InBlock1
    {
        ...
        public double OrdPrc; // [OrdPrc, 15.2] 주문가격                        StartPos 46, Length 15
        public string RegCommdaCode; // [RegCommdaCode,    2] 통신매체코드                    StartPos 61, Length 2
    }

    internal struct _CSPBQ00200OutBlock1
    {
        public long RecCnt; // [RecCnt  ,    5] 레코드갯수                      StartPos 0, Length 5
        public string BnsTpCode; // [BnsTpCode,    1] 매매구분                        StartPos 5, Length 1
        public string AcntNo; // [AcntNo,   20] 계좌번호                        StartPos 6, Length 20
    ...
    internal struct _CSPBQ00200OutBlock2
    {
        public long RecCnt; // [RecCnt  ,    5] 레코드갯수                      StartPos 0, Length 5
        ...
        public double CmsnRat; // [CmsnRat, 15.5] 수수료율                        StartPos 293, Length 15
        ...
        public double FirmMgnRat; // [FirmMgnRat,  7.4] 이용사증거금률                  StartPos 356, Length 7
        public long SubstRuseObjAmt; // [SubstRuseObjAmt  ,   16] 대용재사용대상금액              StartPos 363, Length 16
        public double IsuMgnRat; // [IsuMgnRat,  7.4] 종목증거금률                    StartPos 379, Length 7
        public double AcntMgnRat; // [AcntMgnRat,  7.4] 계좌증거금률                    StartPos 386, Length 7
        public double TrdMgnrt; // [TrdMgnrt,  7.4] 거래증거금률                    StartPos 393, Length 7
