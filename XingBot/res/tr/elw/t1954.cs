namespace XingBot.res
{
    ...
    internal struct _t1954OutBlock
    {
    ...
    internal struct _t1954OutBlock1
    {
        public string date; // [string,    8] 날짜                            StartPos 0, Length 8
        ...
        public float volume; // [float ,   12] 거래량                          StartPos 63, Length 12
        public long bsprice; // [long  ,    8] 기초자산(현물)                  StartPos 76, Length 8
        public float bjprice; // [float ,  8.2] 기초자산(지수)                  StartPos 85, Length 8
        public string bsign; // [string,    1] 전일대비구분                    StartPos 94, Length 1
        public long bschange; // [long  ,    8] 전일대비(현물)                  StartPos 96, Length 8
        public float bjchange; // [float ,  8.2] 전일대비(지수)                  StartPos 105, Length 8
        public float bdiff; // [float ,  6.2] 등락율                          StartPos 114, Length 6
        public float bvolume; // [float ,   12] 기초자산거래량                  StartPos 121, Length 12
        public float parity; // [float ,  6.2] 패리티                          StartPos 134, Length 6
        public float egearing; // [float ,  6.2] e.기어링                        StartPos 141, Length 6
        public float premium; // [float ,  6.2] 프리미엄                        StartPos 148, Length 6
        public float berate; // [float ,  6.2] 손익분기                        StartPos 155, Length 6
        public float capt; // [float ,  6.2] 자본지지                        StartPos 162, Length 6
        public float gearing; // [float ,  6.2] 기어링                          StartPos 169, Length 6
