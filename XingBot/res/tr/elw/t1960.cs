namespace XingBot.res
{
    ...
    public struct _t1960OutBlock1
    {
        ...
        public decimal elwexec; // [double, 10.2] 행사가                          StartPos 81, Length 10
        public decimal convrate; // [double, 12.4] 전환비율                        StartPos 92, Length 12
        ...
        public decimal itemdiff; // [double,  6.2] 기초자산등락율                  StartPos 182, Length 6
        public string elwshcode; // [string,    6] ELW종목코드                     StartPos 189, Length 6
        public decimal bepoint; // [double, 12.2] 손익분기점                      StartPos 196, Length 12
    }
}