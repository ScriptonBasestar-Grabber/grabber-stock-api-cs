namespace XingBot.res
{
    ...
    public class _t1960InBlock
    {
        public string gubun{ get; set; } // [string,    1] 상승하락(0:상승1:하락)          StartPos 0, Length 1
    ...
    public class _t1960OutBlock
    {
        public long idx{ get; set; } // [long  ,    4] IDX                             StartPos 0, Length 4
    }

    public class _t1960OutBlock1
    {
        ...
        public decimal elwexec{ get; set; } // [double, 10.2] 행사가                          StartPos 81, Length 10
        public decimal convrate{ get; set; } // [double, 12.4] 전환비율                        StartPos 92, Length 12
        public string lastdate{ get; set; } // [string,    8] 만기일                          StartPos 105, Length 8
        public string itemcode{ get; set; } // [string,   12] 기초자산종목코드                StartPos 114, Length 12
        public string itemshcode{ get; set; } // [string,    9] 기초자산단축코드                StartPos 127, Length 9
        public string itemname{ get; set; } // [string,   20] 기초자산종목명                  StartPos 137, Length 20
        public string itemprice{ get; set; } // [string,   10] 기초자산현재가                  StartPos 158, Length 10
        public string itemsign{ get; set; } // [string,    1] 기초자산대비구분                StartPos 169, Length 1
        public string itemchange{ get; set; } // [string,   10] 기초자산전일대비                StartPos 171, Length 10
        public decimal itemdiff{ get; set; } // [double,  6.2] 기초자산등락율                  StartPos 182, Length 6
        public string elwshcode{ get; set; } // [string,    6] ELW종목코드                     StartPos 189, Length 6
        public decimal bepoint{ get; set; } // [double, 12.2] 손익분기점                      StartPos 196, Length 12
    }
}