...
namespace XingBot.res.tr.elw
{
    ...
    struct _t1964OutBlock1
    {
        ...
        public float diff; // [float ,  6.2] 등락율                          StartPos 142, Length 6
        public long volume; // [long  ,   12] 거래량                          StartPos 149, Length 12
        public float elwexec; // [float , 10.2] 행사가                          StartPos 162, Length 10
        public long jandatecnt; // [long  ,    8] 잔존일수                        StartPos 173, Length 8
        public float convrate; // [float ,  8.4] 전환비율                        StartPos 182, Length 8
        ...
        public float parity; // [float ,  6.2] 패리티                          StartPos 238, Length 6
        public float preminum; // [float , 10.2] 프리미엄                        StartPos 245, Length 10
        public float spread; // [float ,  3.2] 스프래드                        StartPos 256, Length 3
        public float berate; // [float ,  6.2] 손익분기율                      StartPos 260, Length 6
        public float capt; // [float ,  6.2] 자본지지율                      StartPos 267, Length 6
        public float gearing; // [float ,  6.2] 기어링                          StartPos 274, Length 6
        public float egearing; // [float ,  6.2] e기어링                         StartPos 281, Length 6
        ...
        public float itemdiff; // [float ,  6.2] 기초자산등락율                  StartPos 308, Length 6
        public long itemvolume; // [long  ,   12] 기초자산거래량                  StartPos 315, Length 12
        public long jnilvolume; // [long  ,   12] 전일거래량                      StartPos 328, Length 12
        public float theoryprice; // [float , 10.2] 이론가                          StartPos 341, Length 10
        public float lp_rate; // [float ,  5.2] LP보유비율                      StartPos 352, Length 5
        public float impv; // [float ,  6.2] 내재변동성                      StartPos 358, Length 6
        public float delta; // [float , 10.6] 델타                            StartPos 365, Length 10
        public float theta; // [float , 10.6] 쎄타                            StartPos 376, Length 10
    }
}