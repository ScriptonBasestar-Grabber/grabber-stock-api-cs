namespace XingBot.real.res
{
    ...
    public struct _t1961OutBlock
    {
        public long idx; // [long  ,    4] IDX                             StartPos 0, Length 4
    }

    public struct _t1961OutBlock1
    {
        ...
        public decimal volume; // [double,   12] 누적거래량                      StartPos 68, Length 12
        public decimal jnilvolume; // [double,   12] 전일거래량                      StartPos 81, Length 12
        public decimal elwexec; // [double, 10.2] 행사가                          StartPos 94, Length 10
        public decimal convrate; // [double, 12.4] 전환비율                        StartPos 105, Length 12
        ...
        public decimal itemdiff; // [double,  6.2] 기초자산등락율                  StartPos 195, Length 6
