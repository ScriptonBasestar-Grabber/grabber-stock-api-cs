namespace XingBot.res
{
    ...
    internal struct _t1961OutBlock
    {
        public long idx; // [long  ,    4] IDX                             StartPos 0, Length 4
    }

    internal struct _t1961OutBlock1
    {
        ...
        public double jnilvolume; // [double,   12] 전일거래량                      StartPos 81, Length 12
