namespace XingBot.res
{
    ...
    internal struct _t1956InBlock
    {
        public string shcode; // [string,    6] 단축코드                        StartPos 0, Length 6
    }

    internal struct _t1956OutBlock
    {
        ...
        public float diff; // [float ,  6.2] 등락율                          StartPos 72, Length 6
        public long cvolume; // [long  ,   10] 체결량                          StartPos 79, Length 10
        public float volume; // [float ,   12] 누적거래량                      StartPos 90, Length 12
        public long recprice; // [long  ,    8] 기준가                          StartPos 103, Length 8
        public long avg; // [long  ,    8] 가중평균                        StartPos 112, Length 8
        public float jnilvolume; // [float ,   12] 전일거래량                      StartPos 121, Length 12
        public float jvolume; // [float ,   12] 전일동시간거래량                StartPos 134, Length 12
        public long jnilclose; // [long  ,    8] 전일종가                        StartPos 147, Length 8
        public float volumechg; // [float ,   12] 거래량차                        StartPos 156, Length 12
        public float volumediff; // [float ,  6.2] 거래량차등락율                  StartPos 169, Length 6
        public long open; // [long  ,    8] 시가                            StartPos 176, Length 8
        public float odiff; // [float ,  6.2] 시가등락율                      StartPos 185, Length 6
        public string opentime; // [string,    6] 시가시간                        StartPos 192, Length 6
        public long high; // [long  ,    8] 고가                            StartPos 199, Length 8
        public float hdiff; // [float ,  6.2] 고가등락율                      StartPos 208, Length 6
        public string hightime; // [string,    6] 고가시간                        StartPos 215, Length 6
        public long low; // [long  ,    8] 저가                            StartPos 222, Length 8
        public float ldiff; // [float ,  6.2] 저가등락율                      StartPos 231, Length 6
        public string lowtime; // [string,    6] 저가시간                        StartPos 238, Length 6
        public long high52w; // [long  ,    8] 52최고가                        StartPos 245, Length 8
        public float high52wdiff; // [float ,  6.2] 52최고가등락율                  StartPos 254, Length 6
        public string high52wdate; // [string,    8] 52최고가일                      StartPos 261, Length 8
        public long low52w; // [long  ,    8] 52최저가                        StartPos 270, Length 8
        public float low52wdiff; // [float ,  6.2] 52최저가등락율                  StartPos 279, Length 6
        public string low52wdate; // [string,    8] 52최저가일                      StartPos 286, Length 8
        public float exhratio; // [float ,  6.2] 소진율                          StartPos 295, Length 6
        public float listing; // [float ,   12] 상장주식수(천)                  StartPos 302, Length 12
        public string memedan; // [string,    5] 수량단위                        StartPos 315, Length 5
        public float vol; // [float ,  6.2] 회전율                          StartPos 321, Length 6
        public float parity; // [float ,  8.2] 패리티                          StartPos 328, Length 8
        public float berate; // [float ,  8.2] 손익분기                        StartPos 337, Length 8
        public float gearing; // [float ,  8.2] 기어링                          StartPos 346, Length 8
        public float elwexec; // [float ,  8.2] 행사가                          StartPos 355, Length 8
        public long issueprice; // [long  ,    8] 발행가                          StartPos 364, Length 8
        public float convrate; // [float , 12.4] 전환비율                        StartPos 373, Length 12
        public string lastdate; // [string,    8] 최종거래일                      StartPos 386, Length 8
        public float capt; // [float ,  8.2] 자본지지                        StartPos 395, Length 8
        public float egearing; // [float ,  8.2] e.기어링                        StartPos 404, Length 8
        public float premium; // [float ,  8.2] 프리미엄                        StartPos 413, Length 8
        public float spread; // [float ,  6.2] 스프레드                        StartPos 422, Length 6
        public float espread; // [float ,  6.2] 최대스프레드                    StartPos 429, Length 6
        public float theoryprice; // [float , 10.2] 이론가                          StartPos 436, Length 10
        public float impv; // [float ,  6.2] 내재변동성                      StartPos 447, Length 6
        public string moneyness; // [string,    1] 상태                            StartPos 454, Length 1
        public float delt; // [float ,  8.6] 델타                            StartPos 456, Length 8
        public float gama; // [float ,  8.6] 감마                            StartPos 465, Length 8
        public float vega; // [float , 13.6] 베가                            StartPos 474, Length 13
        public float ceta; // [float , 13.6] 쎄타                            StartPos 488, Length 13
        public float rhox; // [float , 13.6] 로                              StartPos 502, Length 13
        ...
        public float lp_holdvol; // [float ,   12] LP보유수량                      StartPos 578, Length 12
        ...
        public float bdiff; // [float ,  6.2] 기초자산등락율                  StartPos 620, Length 6
        public float bvolume; // [float ,   12] 기초자산거래량                  StartPos 627, Length 12
        ...
        public float givemoney; // [float ,  8.3] 확정지급액                      StartPos 914, Length 8
    }

    internal struct _t1956OutBlock1
    {
        ...
        public float bskdiff; // [float ,  6.2] 기초자산등락율                  StartPos 31, Length 6
        public float bskvolume; // [float ,   12] 기초자산거래량                  StartPos 38, Length 12
