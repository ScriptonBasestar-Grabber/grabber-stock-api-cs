namespace XingBot.res
{
    ...
    public struct _t1955InBlock
    {
        ...
        public decimal elwexecs; // [float , 10.2] 행사가이상                      StartPos 60, Length 10
        public decimal elwexece; // [float , 10.2] 행사가이하                      StartPos 71, Length 10
        public string chkvolume; // [string,    1] 거래량chk구분                   StartPos 82, Length 1
        public decimal volumes; // [float ,   12] 거래량이상                      StartPos 84, Length 12
        public decimal volumee; // [float ,   12] 거래량이하                      StartPos 97, Length 12
        public string chkrate; // [string,    1] 등락율chk구분                   StartPos 110, Length 1
        public decimal rates; // [float ,  6.2] 등락율이상                      StartPos 112, Length 6
        public decimal ratee; // [float ,  6.2] 등락율이하                      StartPos 119, Length 6
        public string chkpremium; // [string,    1] 프리미엄chk구분                 StartPos 126, Length 1
        public decimal premiums; // [float ,  6.2] 프리미엄이상                    StartPos 128, Length 6
        public decimal premiume; // [float ,  6.2] 프리미엄이하                    StartPos 135, Length 6
        public string chkparity; // [string,    1] 패리티chk구분                   StartPos 142, Length 1
        public decimal paritys; // [float ,  6.2] 패리티이상                      StartPos 144, Length 6
        public decimal paritye; // [float ,  6.2] 패리티이하                      StartPos 151, Length 6
        public string chkberate; // [string,    1] 손익분기chk구분                 StartPos 158, Length 1
        public decimal berates; // [float ,  6.2] 손익분기이상                    StartPos 160, Length 6
        public decimal beratee; // [float ,  6.2] 손익분기이하                    StartPos 167, Length 6
        public string chkcapt; // [string,    1] 자본지지chk구분                 StartPos 174, Length 1
        public decimal capts; // [float ,  6.2] 자본지지이상                    StartPos 176, Length 6
        public decimal capte; // [float ,  6.2] 자본지지이하                    StartPos 183, Length 6
        public string chkegearing; // [string,    1] e.기어링chk구분                 StartPos 190, Length 1
        public decimal egearings; // [float ,  6.2] e.기어링이상                    StartPos 192, Length 6
        public decimal egearinge; // [float ,  6.2] e.기어링이하                    StartPos 199, Length 6
        public string chkgearing; // [string,    1] 기어링chk구분                   StartPos 206, Length 1
        public decimal gearings; // [float ,  6.2] 기어링이상                      StartPos 208, Length 6
        public decimal gearinge; // [float ,  6.2] 기어링이하                      StartPos 215, Length 6
        public string chkdelta; // [string,    1] 델타chk구분                     StartPos 222, Length 1
        public decimal deltas; // [float , 10.6] 델타이상                        StartPos 224, Length 10
        public decimal deltae; // [float , 10.6] 델타이하                        StartPos 235, Length 10
        public string chktheta; // [string,    1] 쎄타chk구분                     StartPos 246, Length 1
        public decimal thetas; // [float , 10.6] 쎄타이상                        StartPos 248, Length 10
        public decimal thetae; // [float , 10.6] 쎄타이하                        StartPos 259, Length 10
    ...
    public struct _t1955OutBlock1
    {
        ...
        public decimal diff; // [float ,  6.2] 등락율                          StartPos 125, Length 6
        public decimal volume; // [float ,   12] 거래량                          StartPos 132, Length 12
        public decimal jnilvolume; // [float ,   12] 전일거래량                      StartPos 145, Length 12
        public decimal elwexec; // [float , 10.2] 행사가                          StartPos 158, Length 10
        public string item; // [string,   20] 기초자산명                      StartPos 169, Length 20
        public decimal bprice; // [float , 10.2] 기초자산가                      StartPos 190, Length 10
        public string bsign; // [string,    1] 기초전일대비구분                StartPos 201, Length 1
        public decimal bchange; // [float , 10.2] 기초전일대비                    StartPos 203, Length 10
        public decimal bdiff; // [float ,  6.2] 기초등락율                      StartPos 214, Length 6
        public decimal premium; // [float ,  6.2] 프리미엄                        StartPos 221, Length 6
        public decimal parity; // [float ,  6.2] 패리티                          StartPos 228, Length 6
        public decimal berate; // [float ,  6.2] 손익분기                        StartPos 235, Length 6
        public decimal capt; // [float ,  6.2] 자본지지                        StartPos 242, Length 6
        public decimal egearing; // [float ,  6.2] e.기어링                        StartPos 249, Length 6
        public decimal gearing; // [float ,  6.2] 기어링                          StartPos 256, Length 6
        public string lastdate; // [string,    8] 최종거래일                      StartPos 263, Length 8
        public decimal delta; // [float , 10.6] 델타                            StartPos 272, Length 10
        public decimal theta; // [float , 10.6] 쎄타                            StartPos 283, Length 10
    }
}