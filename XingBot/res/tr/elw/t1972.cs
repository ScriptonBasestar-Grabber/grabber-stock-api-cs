namespace XingBot.real.res
{
    ...
    public struct _t1972OutBlock
    {
        ...
        public decimal ddiff1; // [float ,  6.2] 매도비율1                       StartPos 130, Length 6
        public decimal sdiff1; // [float ,  6.2] 매수비율1                       StartPos 137, Length 6
        ...
        public decimal ddiff2; // [float ,  6.2] 매도비율2                       StartPos 210, Length 6
        public decimal sdiff2; // [float ,  6.2] 매수비율2                       StartPos 217, Length 6
        ...
        public decimal ddiff3; // [float ,  6.2] 매도비율3                       StartPos 290, Length 6
        public decimal sdiff3; // [float ,  6.2] 매수비율3                       StartPos 297, Length 6
        ...
        public decimal ddiff4; // [float ,  6.2] 매도비율4                       StartPos 370, Length 6
        public decimal sdiff4; // [float ,  6.2] 매수비율4                       StartPos 377, Length 6
        ...
        public decimal ddiff5; // [float ,  6.2] 매도비율5                       StartPos 450, Length 6
        public decimal sdiff5; // [float ,  6.2] 매수비율5                       StartPos 457, Length 6
        ...
        public decimal fwddiff; // [float ,  6.2] 외국계매도합계비율              StartPos 516, Length 6
        public decimal fwsdiff; // [float ,  6.2] 외국계매수합계비율              StartPos 523, Length 6
    }
}