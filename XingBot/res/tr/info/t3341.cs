...
namespace XingBot.res.tr.info
{
    ...
    struct _t3341OutBlock1
    {
        ...
        public float per; // [float , 13.2] PER                             StartPos 137, Length 13
        public float pbr; // [float , 13.2] PBR                             StartPos 151, Length 13
        public float peg; // [float , 13.2] PEG                             StartPos 165, Length 13
    }
}