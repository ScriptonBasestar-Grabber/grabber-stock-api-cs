namespace XingBot.res
{
    ...
    public struct _t3518OutBlock1
    {
        ...
        public decimal open; // [double,  9.4] 시가                            StartPos 18, Length 9
        public decimal high; // [double,  9.4] 고가                            StartPos 28, Length 9
        public decimal low; // [double,  9.4] 저가                            StartPos 38, Length 9
        public decimal price; // [double,  9.4] 현재가                          StartPos 48, Length 9
        public string sign; // [string,    1] 전일대비구분                    StartPos 58, Length 1
        public decimal change; // [double,  9.4] 전일대비                        StartPos 60, Length 9
        public decimal uprate; // [double,  9.4] 등락율                          StartPos 70, Length 9
        public decimal volume; // [double,   12] 누적거래량                      StartPos 80, Length 12
        public decimal bidho; // [double,  9.4] 매수호가                        StartPos 93, Length 9
        public decimal offerho; // [double,  9.4] 매도호가                        StartPos 103, Length 9
        public decimal bidrem; // [double,   12] 매수잔량                        StartPos 113, Length 12
        public decimal offerrem; // [double,   12] 매도잔량                        StartPos 126, Length 12
