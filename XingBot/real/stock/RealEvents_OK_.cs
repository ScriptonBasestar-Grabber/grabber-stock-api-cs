...
namespace XingBot.real
{
    ...
    {
        public void InBlock_OK_(string shcode)
        {
            string szTrCode = "OK_";
            _realDict[szTrCode].SetFieldData("InBlock", "shcode", shcode);
        }

        private void OutBlock_OK_(string szTrCode)
        {
            _OK__OutBlock outData;
            ...
            outData.tradmdrate1 = decimal.Parse(_realDict[szTrCode].GetFieldData("OutBlock", "tradmdrate1"));
            outData.tradmsrate1 = decimal.Parse(_realDict[szTrCode].GetFieldData("OutBlock", "tradmsrate1"));
            ...
            outData.tradmdrate2 = decimal.Parse(_realDict[szTrCode].GetFieldData("OutBlock", "tradmdrate2"));
            outData.tradmsrate2 = decimal.Parse(_realDict[szTrCode].GetFieldData("OutBlock", "tradmsrate2"));
            ...
            outData.tradmdrate3 = decimal.Parse(_realDict[szTrCode].GetFieldData("OutBlock", "tradmdrate3"));
            outData.tradmsrate3 = decimal.Parse(_realDict[szTrCode].GetFieldData("OutBlock", "tradmsrate3"));
            ...
            outData.tradmdrate4 = decimal.Parse(_realDict[szTrCode].GetFieldData("OutBlock", "tradmdrate4"));
            outData.tradmsrate4 = decimal.Parse(_realDict[szTrCode].GetFieldData("OutBlock", "tradmsrate4"));
            ...
            outData.tradmdrate5 = decimal.Parse(_realDict[szTrCode].GetFieldData("OutBlock", "tradmdrate5"));
            outData.tradmsrate5 = decimal.Parse(_realDict[szTrCode].GetFieldData("OutBlock", "tradmsrate5"));
            ...
            outData.ftradmdrate = decimal.Parse(_realDict[szTrCode].GetFieldData("OutBlock", "ftradmdrate"));
            outData.ftradmsrate = decimal.Parse(_realDict[szTrCode].GetFieldData("OutBlock", "ftradmsrate"));
