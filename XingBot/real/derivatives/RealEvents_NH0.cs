...
namespace XingBot.real
{
    ...
    {
        public void InBlock_NH0(string futcode)
        {
            string szTrCode = "NH0";
            _realDict[szTrCode].SetFieldData("InBlock", "futcode", futcode);
        }

        private void OutBlock_NH0(string szTrCode)
        {
            _NH0_OutBlock outData;
            outData.hotime = _realDict[szTrCode].GetFieldData("OutBlock", "hotime");
            outData.hotime1 = _realDict[szTrCode].GetFieldData("OutBlock", "hotime1");
