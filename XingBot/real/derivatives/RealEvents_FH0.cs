...
namespace XingBot.real
{
    public partial class RealCtrl : _IXARealEvents
    {
        ...
        private void OutBlock_FH0(string szTrCode)
        {
            ...
            outData.offerho2 = decimal.Parse(_realDict[szTrCode].GetFieldData("OutBlock", "offerho2"));
            outData.bidho2 = decimal.Parse(_realDict[szTrCode].GetFieldData("OutBlock", "bidho2"));
            ...
            outData.offerho3 = decimal.Parse(_realDict[szTrCode].GetFieldData("OutBlock", "offerho3"));
            outData.bidho3 = decimal.Parse(_realDict[szTrCode].GetFieldData("OutBlock", "bidho3"));
            ...
            outData.offerho4 = decimal.Parse(_realDict[szTrCode].GetFieldData("OutBlock", "offerho4"));
            outData.bidho4 = decimal.Parse(_realDict[szTrCode].GetFieldData("OutBlock", "bidho4"));
            ...
            outData.offerho5 = decimal.Parse(_realDict[szTrCode].GetFieldData("OutBlock", "offerho5"));
            outData.bidho5 = decimal.Parse(_realDict[szTrCode].GetFieldData("OutBlock", "bidho5"));
            ...
            outData.totofferrem = long.Parse(_realDict[szTrCode].GetFieldData("OutBlock", "openyakcha"));
            outData.totbidrem = long.Parse(_realDict[szTrCode].GetFieldData("OutBlock", "openyakcha"));
            outData.totoffercnt = long.Parse(_realDict[szTrCode].GetFieldData("OutBlock", "openyakcha"));
            outData.totbidcnt = long.Parse(_realDict[szTrCode].GetFieldData("OutBlock", "openyakcha"));
            outData.futcode = _realDict[szTrCode].GetFieldData("OutBlock", "openyakcha");
            outData.danhochk = _realDict[szTrCode].GetFieldData("OutBlock", "openyakcha");
            outData.alloc_gubun = _realDict[szTrCode].GetFieldData("OutBlock", "openyakcha");
        }
    }
}
