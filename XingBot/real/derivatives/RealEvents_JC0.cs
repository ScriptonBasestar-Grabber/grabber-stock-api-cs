...
namespace XingBot
{
    public partial class RealEvents : _IXARealEvents
    {
        ...
        private void OutBlock_JC0(string szTrCode)
        {
            ...
            outData.drate = double.Parse(_RealDict[szTrCode].GetFieldData("OutBlock", "drate"));
            ...
            outData.cpower = double.Parse(_RealDict[szTrCode].GetFieldData("OutBlock", "cpower"));
            ...
            outData.k200jisu = double.Parse(_RealDict[szTrCode].GetFieldData("OutBlock", "k200jisu"));
            outData.theoryprice = long.Parse(_RealDict[szTrCode].GetFieldData("OutBlock", "theoryprice"));
            outData.kasis = double.Parse(_RealDict[szTrCode].GetFieldData("OutBlock", "kasis"));
